...
export const getAllRecipes = () => {
    return async (dispatch) => {
        try {
            let infoAll = await axios.get('https://api-food-production-29c5.up.railway.app/recipes');
...
export const getRecipeName = (name) => {
    return async (dispatch) => {
        try {
            let infoName = await axios.get(`https://api-food-production-29c5.up.railway.app/recipes?name=${name}`);
...
export const getRecipeDetail = (id) => {
    return async (dispatch) => {
        try {
            let infoDetails = await axios.get(`https://api-food-production-29c5.up.railway.app/recipes/${id}`);
...
export const postRecipe = (payload) => {
    try {
        return async () => {
            let newRecipe = await axios.post('https://api-food-production-29c5.up.railway.app/recipes', payload);
            return newRecipe;
        };
    } catch (error) {
        console.log( error)
...
export const getAllDiets = () => {
    return async (dispatch) => {
        try {
            let diets = await axios.get('https://api-food-production-29c5.up.railway.app/diets');
